<template>
  <nuxt-link class="px-3 py-3 text-lg text-main-600 rounded-full text-center dark:text-gray-100" @click.native="to ? null : $router.go(-2)" :to="to ? to : '/'">
    ...
    <slot class="fill-current uppercase">go back</slot>
  </nuxt-link>
</template>
